...
@php
    //dddx($_theme->menu()['slim-header-menu']);
@endphp
                            ...
                            <div class="nav-mobile">
                                <nav>
                                    ...
                                    <div class="link-list-wrapper collapse" id="menu-principale">
                                        <ul class="link-list">
                                            @each('pub_theme::layouts.partials.slim-header-menu-item', $_theme->menu()['slim-header-menu'], 'item')
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                            ...
                            <nav class="navbar navbar-expand-lg has-megamenu">
                                ...
                                <div class="navbar-collapsable" id="nav10">
                                    ...
                                    <div class="menu-wrapper">
                                        <ul class="navbar-nav">
                                            @each('pub_theme::layouts.partials.header-menu-item', $_theme->menu()['header-menu'], 'item')
                                        </ul>
                                    </div>
    ...
    <footer class="it-footer">
        <div class="it-footer-main">
            <div class="container">
                ...
                <section>
                    <div class="row">
                        @each('pub_theme::layouts.partials.footer-menu-item', $_theme->menu()['footer-menu'], 'item')
                    </div>
                </section>
        ...
        <div class="it-footer-small-prints clearfix">
            <div class="container">
                ...
                <ul class="it-footer-small-prints-list list-inline mb-0 d-flex flex-column flex-md-row">
                    @each('pub_theme::layouts.partials.footer-bar-item', $_theme->menu()['footer-bar'], 'item')
                </ul>
            </div>
        </div>
    </footer>
